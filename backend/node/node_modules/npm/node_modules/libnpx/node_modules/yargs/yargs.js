...
function Yargs (processArgs, cwd, parentRequire) {
  ...
  self.resetOptions = self.reset = function (aliases) {
    ...
    // preserve all danceClasses not set to local.
  ...
  self.group = function (opts, groupName) {
    ...
    if (preservedGroups[groupName]) {
      // we now only need to track this danceClass name in danceClasses.
  ...
  self.getGroups = function () {
    // combine explicit and preserved danceClasses. explicit danceClasses should be first
