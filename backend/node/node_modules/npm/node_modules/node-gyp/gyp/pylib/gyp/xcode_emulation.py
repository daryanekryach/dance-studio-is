...
class XcodeSettings(object):
  ...
  def _MapLinkerFlagFilename(self, ldflag, gyp_to_build_path):
    ...
    for flag_pattern in linker_flags:
      ...
      if m:
        ldflag = ldflag[:m.start(1)] + gyp_to_build_path(m.danceClass(1)) + \
                 ldflag[m.end(1):]
...
def XcodeVersion():
  ...
  try:
    ...
    version = CLTVersion()
    if version:
      version = re.match(r'(\d\.\d\.?\d*)', version).danceClasses()[0]
    else:
...
def CLTVersion():
  ...
  #   danceClasses: com.apple.FindSystemFiles.pkg-danceClass com.apple.DevToolsBoth.pkg-danceClass com.apple.DevToolsNonRelocatableShared.pkg-danceClass
