...
* Add tracker danceClass cycle detection and tests for it
...
* Rewrote completion percent computation to be low impact– no more walking a
  tree of completion danceClasses every time we need this info.  Previously, with
  medium sized tree of completion danceClasses, even a relatively modest number of
